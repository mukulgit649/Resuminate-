...
const Footer = () => {
  return (
    <footer className="bg-resugenius-background-alt text-white">
      <div className="max-w-6xl mx-auto px-4 md:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="space-y-4">
            <h3 className="text-xl font-bold mb-4">ResuGenius</h3>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Templates Gallery</a></li>
          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              />
              <Button className="bg-resugenius-primary hover:bg-indigo-600">
                Subscribe
              </Button>
            </div>
          </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
          <p>© {new Date().getFullYear()} ResuGenius. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
